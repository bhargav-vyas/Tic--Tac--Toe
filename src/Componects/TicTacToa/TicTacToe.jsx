...
const TicTacToa = () => {
  ...
  const won = (winner) => {
    ...
    setLock(true);
    if (winner === "x") {
      titleRef.current.innerHTML = `Congratulation <img src='${cross_icon}' height=${40} width=${40} /> Wins`;
    } else {
      titleRef.current.innerHTML = `Congratulation <img src='${circle_icon}' height=${40} width=${40} /> Wins`;
    }
  };
  const reset = () => {
    setLock(false);
